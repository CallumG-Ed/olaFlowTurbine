...
def getTurbineVars():
    ...
    return t, Az, Cp, blade_l, hub_x, hub_y, hub_z
...
t, Az, Cp, blade_l, hub_x, hub_y, hub_z = getTurbineVars()
...
for file in files:
    ...
    if blade == 1:
        ...
        #Moments
        results[:,5] = results[:,5] + (table.y*table.fz) - (table.z*table.fy)
        results[:,6] = results[:,6] + (table.z*table.fx) - (table.x*table.fz)
        results[:,7] = results[:,7] + (table.x*table.fy) - (table.y*table.fx)
        ...
        #Moments
        results[:,11] = results[:,11] + (table.y*table.fz) - (table.z*table.fy)
        results[:,12] = results[:,12] + (table.z*table.fx) - (table.x*table.fz)
        results[:,13] = results[:,13] + (table.x*table.fy) - (table.y*table.fx)
        ...
        #Moments
        results[:,17] = results[:,17] + (table.y*table.fz) - (table.z*table.fy)
        results[:,18] = results[:,18] + (table.z*table.fx) - (table.x*table.fz)
        results[:,19] = results[:,19] + (table.x*table.fy) - (table.y*table.fx)
